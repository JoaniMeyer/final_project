#!/usr/bin/env python3
"""
African Moral Classification Trainer V2
...
class AfricanMoralTrainerV2:
    """Improved trainer for African moral classification using AfroXLM-R"""
    ...
    def train_model(self, train_dataset: CustomDataset, val_dataset: CustomDataset, 
                   output_dir: str = "./african_moral_classifier_V2") -> None:
        ...
        training_args = TrainingArguments(
            ...
            num_train_epochs=5,  
            per_device_train_batch_size=4,  # for better gradient updates
            per_device_eval_batch_size=4,   # for consistency
            learning_rate=3e-5,  
            warmup_ratio=0.15,   
            weight_decay=0.005,  
            ...
            save_total_limit=5,  # Keep checkpoints
            dataloader_num_workers=2,  # for stability
        ...
        # Train the model
        print("Training model (5 epochs with improved settings)...")
    ...
    def evaluate_model(self, val_dataset: CustomDataset) -> Dict[str, Any]:
        ...
        os.makedirs("./african_moral_classifier_V2", exist_ok=True)
        with open("./african_moral_classifier_V2/evaluation_results.json", 'w') as f:
    ...
    def plot_confusion_matrix(self, cm: np.ndarray, save_path: str = "./african_moral_classifier_V2/confusion_matrix.png"):
        ...
        try:
            ...
            plt.title('Confusion Matrix - African Moral Classification V2')
    ...
    def save_model_info(self, output_dir: str = "./african_moral_classifier_V2", texts: Optional[List[str]] = None):
...
def main():
    ...
    print(f"🚀 Starting African Moral Classification Training V2")
    print("="*70)
    
    # Initialize trainer
    trainer = AfricanMoralTrainerV2()
    ...
    print("Model saved to: ./african_moral_classifier_V2/")
    print("Evaluation results saved to: ./african_moral_classifier_V2/evaluation_results.json")
